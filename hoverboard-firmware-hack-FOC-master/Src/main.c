...
int main(void) {
  ...
  while(1) {
    ...
    calcAvgSpeed();                  		// Calculate average measured speed: speedAvg, speedAvgAbs
      ...
      speed_l = (int16_t)(steerFixdt >> 16);  // convert fixed-point to integer
      speed_r = (int16_t)(speedFixdt >> 16);  // convert fixed-point to integer    
      ...
      // ####### MIXER #######
       //speedR = CLAMP((int)(speed * SPEED_COEFFICIENT -  steer * STEER_COEFFICIENT)>>4, -1000, 1000);
